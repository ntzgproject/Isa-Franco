    ...
    <>
      ...
      <img src="/logos/Isa Franco Logo.png" alt="logo-isafranco" className='logo-footer' />
        ...
        <div className='canales-container'>
          ...
          <Link href="https://www.instagram.com/isa_franco/" target="_blank" rel="noopener noreferrer">
            <img src="/public/logos/Instagram.png" alt="Instagram" className='redes-logo' />
          </Link>

          <Link href="https://www.facebook.com/IsaFrancoMotos" target="_blank" rel="noopener noreferrer">
            <img src="/public/logos/Facebook.png" alt="Facebook" className='redes-logo' />
          </Link>

          <Link href="https://wa.me/5491155125679" target="_blank" rel="noopener noreferrer">
      ...
      <div className='contacto-container'>
        ...
        <article className='contacto-1'>
          <div>
            ...
            <tel className='numero'>351-510-9239.</tel>
          </div>
          <iframe
          ...
          <article className='contacto-2'>
              <div>
                ...
                <tel className='contacto'>351-880-1601.</tel>
              </div>
